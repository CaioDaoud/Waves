...
int main(int argc, char **argv)
{
	...
	//voc_word  = new Vocabulario(50000000, 400000, argv[3], 0);
	voc_word = new Vocabulario(10000000, 10000000, argv[3], 0);
	...
	cout << "Numero de documentos na base " << descritor->get_num_docs() << endl;
